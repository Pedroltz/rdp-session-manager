...
class RDPSessionManagerApp(Adw.Application):
    ...
    def show_xrdp_install_dialog(self):
        ...
        dialog = Adw.MessageDialog(
            ...
            body="The xrdp server is required to create remote RDP sessions.\n\nWould you like to install it now?"
        )
    ...
    def install_xrdp_with_progress(self):
        ...
        progress_dialog = Adw.MessageDialog(
            ...
            body="Installing the RDP server...\nThis may take a few minutes."
        )
    ...
    def show_xrdp_success(self):
        ...
        dialog = Adw.MessageDialog(
            ...
            body="The xrdp server was installed and configured successfully.\n\nYou can now create RDP users!"
        )
    ...
    def show_xrdp_error(self, error):
        ...
        dialog = Adw.MessageDialog(
            ...
            body=f"xrdp could not be installed.\n\nError: {error}\n\nThe xrdp server is REQUIRED to create RDP users.\n\nYou can:\n• Try installing it again\n• Install it manually: sudo apt install xrdp"
        )
        dialog.add_response("cancel", "Cancel")
        dialog.add_response("retry", "Tentar Novamente")
        dialog.add_response("manual", "View Instructions")
    ...
    def show_manual_install_instructions(self):
        ...
        instructions = """To install xrdp manually, run these commands in a terminal:
...
After the manual installation, restart this application so xrdp can be detected."""

        dialog = Adw.MessageDialog(
            transient_for=self.window,
            heading="Manual xrdp Installation",
            body=instructions
        )
...
sudo systemctl status xrdp"""
            ...
            if hasattr(self.window, 'show_toast'):
                self.window.show_toast("OK Commands copied to the clipboard!")
    ...
    def install_freerdp_with_progress(self):
        ...
        progress_dialog = Adw.MessageDialog(
            ...
            body="Installing the RDP client...\nThis may take a few minutes."
        )
    ...
    def show_freerdp_success(self):
        ...
        dialog = Adw.MessageDialog(
            ...
            body="The FreeRDP client was installed successfully.\n\nYou can now connect to your RDP users!"
        )
        dialog.add_response("ok", "OK")
        dialog.present()
    ...
    def show_freerdp_error(self, error):
        ...
        dialog = Adw.MessageDialog(
            ...
            body=f"FreeRDP could not be installed.\n\nError: {error}\n\nYou can:\n• Try installing it again\n• Install it manually: sudo apt install freerdp3-x11"
        )
        dialog.add_response("cancel", "Cancel")
        dialog.add_response("retry", "Tentar Novamente")
        dialog.set_response_appearance("retry", Adw.ResponseAppearance.SUGGESTED)
